---
name: mongodb
description: MongoDB standards — indexing, F-P-S-L queries, aggregation pipelines, schema design, and safety.
---
...
- Regular index maintenance — review unused indexes in production.
